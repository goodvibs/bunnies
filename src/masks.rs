...
pub const WHITE_CASTLING_CHECK_MASK_SHORT: Bitboard =
    KING_SIDE & (STARTING_WK | STARTING_WB | STARTING_WN);
pub const WHITE_CASTLING_CHECK_MASK_LONG: Bitboard =
    (QUEEN_SIDE | FILE_E) & (STARTING_WK | STARTING_WQ | STARTING_WB);
pub const BLACK_CASTLING_CHECK_MASK_SHORT: Bitboard =
    KING_SIDE & (STARTING_BK | STARTING_BB | STARTING_BN);
pub const BLACK_CASTLING_CHECK_MASK_LONG: Bitboard =
    (QUEEN_SIDE | FILE_E) & (STARTING_BK | STARTING_BQ | STARTING_BB);

pub const CASTLING_CHECK_MASK_SHORT: [Bitboard; 2] = [
    WHITE_CASTLING_CHECK_MASK_SHORT,
    BLACK_CASTLING_CHECK_MASK_SHORT,
];
pub const CASTLING_CHECK_MASK_LONG: [Bitboard; 2] = [
    WHITE_CASTLING_CHECK_MASK_LONG,
    BLACK_CASTLING_CHECK_MASK_LONG,
];
